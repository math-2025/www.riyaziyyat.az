...
import { PlusCircle, Trash2, Image as ImageIcon, Loader } from "lucide-react";
  ...
  if (isLoading) {
    return (
        <div className="space-y-8">
            ...
            <Card>
                <CardHeader><CardTitle>Suallar</CardTitle></CardHeader>
                <CardContent>
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Button type="submit" className="w-full md:w-auto">Dəyişiklikləri Yadda Saxla</Button>
      </form>
    </Form>
  );
}
